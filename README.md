...
Pipeline de Ingesta: Carga de PDFs, división de texto en fragmentos (chunks) y generación de embeddings para almacenamiento en chroma_db.
...
Interfaz de Agente: * Se intentó inicialmente una implementación mediante Agentes ReAct (AgentExecutor) para otorgar autonomía en la toma de decisiones.

Ante desafíos de compatibilidad de versiones de librerías modernas (LangChain 0.3.x / Pydantic V2), se migró exitosamente a una arquitectura de RAG Directo, garantizando estabilidad y precisión en la respuesta del LLM.
...
Este proyecto forma parte de la evaluación de IA para el análisis de cumplimiento normativo y derecho laboral.
